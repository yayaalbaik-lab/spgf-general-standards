...
- Added `SPGF Constitution v6.2` as the general project governance constitution.
...
- Added `SPGF_Constitution_v6.3_DRAFT.md` as the corrective draft source for critical v6.2 errata items.
